...
listContainer.addEventListener(
  ...
  false //"Handle the event during the bubbling phase." This is the most common behavior, where the event first happens on the clicked element (e.g., <li>) and then bubbles up to its parent elements (e.g., the <ul>).
);
